...
<#
    ...
    .SYNOPSIS
    Deploys Aria Operations for Intelligent Operations Management.

    .DESCRIPTION
    The iomDeployVrealizeOperations.ps1 provides a single script to deploy and configure Aria Operations
    as defined by the Intelligent Operations Management for VMware Cloud Foundation validated solution.
    ...
    This example performs the deployment and configure of Aria Operations using the parameters provided within the Planning and Preparation Workbook.
    ...
    This example performs a minimal footprint deployment and configuration of Aria Operations using the parameters provided within the Planning and Preparation Workbook.
#>
...
Try {
    ...
    if (Test-VCFConnection -server $sddcManagerFqdn ) {
        ...
        if (Test-VCFAuthentication -server $sddcManagerFqdn -user $sddcManagerUser -pass $sddcManagerPass) {
            ...
            $licenseAlias                   = if ($pnpWorkbook.Workbook.Names["vrs_license"].Value) {  "Aria Suite" } else { "Aria Operations" }
            ...
            # Add the Aria Operations License to Aria Suite Lifecycle
            ...
            # Import the Certificate for Aria Operations to Aria Suite Lifecycle
            ...
            # Add the Aria Operations Password to Aria Suite Lifecycle
            ...
            # Deploy Aria Operations by Using Aria Suite Lifecycle
            if (!$PsBoundParameters.ContainsKey("nested")) {
            ...
            # Create Virtual Machine and Template Folders for the Aria Operations Virtual Machines
            ...
            # Move the Aria Operations Virtual Machines to the Dedicated Folders
            Write-LogMessage -type INFO -Message "Move the $operationsProductName Appliances to the Dedicated Folders"
            ...
            # Configure vSphere DRS Anti-Affinity Rules for the Aria Operations Virtual Machines
            ...
            # Create a VM Group and Define the Startup Order of the Aria Operations Analytics Cluster Virtual Machines
            ...
            # Create a VM Group and Define the Startup Order of the Aria Operations Remote Collector Virtual Machines
            ...
            if ($stretchedCluster -eq "Include") {
                # Add the Aria Operations Virtual Machines to the First Availability Zone VM Group
            ...
            # Group the Aria Operations Collector Nodes
            ...
            # Synchronize the Active Directory Groups for Aria Operations in Workspace ONE Access 
            ...
            # Configure User Access in Aria Operations
            ...
            # Set the Currency for Cost Calculation in Aria Operations
            ...
            # Configure Email Alert Plug-in Settings for Aria Operations
