...
- Added `Get-NsxtGlobalManagerEdgeClusters` cmdlet to retrieve the NSX Edge cluster information for the specified location.
- Added `Get-NsxtGlobalManagerTier1LocaleServices` cmdlet to retrieve the locale services of Tier-1 gateway from the NSX Global Manager.
- Added `New-NsxtGlobalManagerTier1Gateway` cmdlet to create a Tier 1 Gateway
