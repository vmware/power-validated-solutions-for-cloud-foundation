...
```powershell
Undo-TanzuKubernetesCluster [-server] <String> [-user] <String> [-pass] <String> [-domain] <String> [-cluster] <String> [-namespace] <String> [-tkc] <String> [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
