...
```powershell
Undo-vROPSDeployment [-server] <String> [-user] <String> [-pass] <String> [[-environmentName] <String>] [-monitor] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

## Description

The `Undo-vROPSDeployment` cmdlet removes VMware Aria Operations from VMware Aria Suite Lifecycle.
